...
ActiveRecord::Schema[8.1].define(version: 2025_07_25_100400) do
  ...
  create_table "alerts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["family_id", "alert_type", "alertable_type", "alertable_id"], name: "index_alerts_uniqueness", unique: true
    t.index ["family_id", "created_at"], name: "index_alerts_on_family_id_and_created_at"
  ...
  create_table "families", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.decimal "large_transaction_threshold", precision: 19, scale: 4
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["rss_feed_key"], name: "index_users_on_rss_feed_key", unique: true, where: "(rss_feed_key IS NOT NULL)"
  end
